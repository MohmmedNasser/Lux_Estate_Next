...
export function FeaturedPropertyCard({ property }: { property: Property }) {
  ...
  return (
    <article
      className="group relative flex h-full flex-col overflow-hidden rounded-2xl bg-white ring-1 ring-neutral-200/80 shadow-[0_1px_2px_rgba(16,24,40,0.04)] transition-[box-shadow,transform,ring-color] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1.5 hover:shadow-[0_28px_56px_-20px_rgba(16,24,40,0.22)] hover:ring-neutral-300 focus-within:ring-2 focus-within:ring-amber-600"
    >
      <div className="relative aspect-16/11 w-full overflow-hidden bg-neutral-100">
        ...
        <motion.button
          ...
          className={cn(
            ...
            isFavorited && "text-rose-600 [@media(hover:hover)]:opacity-100",
          )}
        >
          <Heart
            aria-hidden="true"
